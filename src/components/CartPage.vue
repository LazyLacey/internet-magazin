<template>
  <div class="cart-page">
    <div class="body">
      <ul>
        <div v-for="good in EventBus.cartGoods" :key="good.title" class="good-position">
          <div class="good-img">
            <img :src="good.img">
          </div>
          <div class="good-name">
          ...
          <div class="good-number">
            ...
            <div class="minus" @click="EventBus.removeFromCart(good.title)">
            ...
            <div class="plus" @click="EventBus.addToCart(good.title)">
            ...
            <div class="delete" @click="EventBus.deleteFromCart(good.title)">
