<template>
  <div class="cart" :class="{ 'yea-modal': modal }">
    <div v-if="!modal" class="cart-label" @click="openModal">
      <div class="text" v-text="'В корзине: ' + cartNumber" />
    </div>
        ...
        <ul>
          <div v-for="good in cartGoods" :key="good.title" class="good-position">
            ...
            <div class="good-number">
              ...
              <div class="minus" @click="removeFromCart(good.title)">
              ...
              <div class="plus" @click="addToCart(good.title)">
              ...
              <div class="delete" @click="deleteFromCart(good.title)">
...
export default {
  ...
  computed: {
    ...mapGetters(['cartNumber', 'cartSum', 'cartGoods'])
  },
  methods: {
    openModal: function () {
      this.modal = true
    ...
    removeFromCart (value) {
      store.commit('removeFromCart', value)
    },
    addToCart (value) {
      store.commit('addToCart', value)
    },
    deleteFromCart (value) {
      store.commit('deleteFromCart', value)
    }
  }
}
</script>
